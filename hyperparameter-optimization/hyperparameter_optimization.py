...
def build_model_spec(assignments):
    """
    ...
    return ModelSpec(
        ...
        sgd_RegularizationAmount=math.exp(assignments['log_regularization_amount']),
        sgd_RegularizationType=assignments['regularization_type'],
    )
